---
title: "Codebook created on 2021-11-17 at 2021-11-17 15:39:01"
...
## Dataset description
The data contains 1500 cases and 18 variables.

## Codebook

```{r}
summaries <- read.csv("./codebook_ca.imputation.csv", stringsAsFactors = FALSE)
